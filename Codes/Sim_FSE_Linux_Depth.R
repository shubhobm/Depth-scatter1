...
system.time(norm.table <- FSE.norm(n.vec, 2, 1e3, ncores=8))
system.time(t5.table <- FSE.t(n.vec, 2, df=5, 1e3, ncores=8))
system.time(t6.table <- FSE.t(n.vec, 2, df=6, 1e3, ncores=8))
system.time(t10.table <- FSE.t(n.vec, 2, df=10, 1e3, ncores=8))
system.time(t15.table <- FSE.t(n.vec, 2, df=15, 1e3, ncores=8))
system.time(t25.table <- FSE.t(n.vec, 2, df=25, 1e3, ncores=8))
...
write.csv(format(round(table2, 2), nsmall=2), "table2d.txt")
